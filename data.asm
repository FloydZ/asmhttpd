...
%define LISTEN_PORT 0x5000 ; PORT 80, network byte order
	...
	msg_help      db "Usage: ./asmttpd /path/to/directory numThreads Port",0x00
	...
	msg_request_log_len equ $ - msg_request_log
        msg_send_log db 0x0a,"Send: ",0x00
	msg_send_log_len equ $ - msg_send_log
	...
	http_404_text db "I'm sorry. I'm afraid I can't do that. 404 Not Found",0x00
	...
	server_header db     "Server: nil/",ASMTTPD_VERSION,0x0d,0x0a,0x00
	...
	extension_html	   db ".html",0x00
        extension_html_len equ $ - extension_html 

	extension_htm  	   db ".htm" ,0x00
        extension_htm_len equ $ - extension_htm 
...
%ifdef DEBUG
       testlong     db "Error - Bind() failed. Check if port is in use or you have sufficient privileges.",0x00
        testright     db "privileges.",0x00
        testcopy    db "ErroBsdkuhfbgshkjfbhkjsbdfhkjbhsifhpdjhopkfsghkfhkopfgkophkgüpfosgkhüpoijfsgpihoudsfgsfuigfsuzdgfuidshu",0x00
        testcopy_len equ $ - testcopy
%endif